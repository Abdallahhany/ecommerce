...
import {getProductDetails, clearErrors, newReview} from "../../actions/product_action";
import {useAlert} from "react-alert";
import Loader from "../layouts/loader";
import MetaData from "../layouts/meta_data";
import {Carousel} from "react-bootstrap";
import {addItemToCart,} from "../../actions/cart_action";
import {NEW_REVIEW_RESET} from "../../consts/product_consts";
import ListReviews from "../review/list_review";
                ...
                (<Fragment>
                    ...
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            <h3>{product.name}</h3>
                            <p id="product_id">Product # {match.params.id}</p>
                            <hr/>
                            ...
                            {user ?
                                <button id="review_btn" type="button" className="btn btn-primary mt-4"
                                        data-toggle="modal"
                                        data-target="#ratingModal" onClick={setUserRating}>
                                    Submit Your Review
                                </button>
                                :
                                <div className="alert alert-danger mt-5" typeof='alert'>Login To Post Your Review</div>
                            }
