...
export const newReview = (reviewData) => async (dispatch) => {
    ...
    try {
        ...
        const {data} = await axios.put(uri, reviewData, config)
...
export const getAdminProducts = () => async (dispatch) => {
    const uri = '/api/v1/admin/products';
    try {
...
export const newProduct = (productData) => async (dispatch) => {
    const uri = '/api/v1/admin/product/new';
    try {
        ...
        const {data} = await axios.post(uri, productData, config)
...
export const deleteProduct = (id) => async (dispatch) => {
    const uri = `/api/v1/admin/product/${id}`;
    try {
